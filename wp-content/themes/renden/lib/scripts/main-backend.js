...
jQuery(document).ready(function(){
	...
	if(jQuery('tr._thinkup_meta_teamstyleswitch input[value=option3]').is(":checked")){
		jQuery('tr._thinkup_meta_teamlayout').show();
	} else if(jQuery('tr._thinkup_meta_teamstyleswitch input[value=option3]').not(":checked")){
