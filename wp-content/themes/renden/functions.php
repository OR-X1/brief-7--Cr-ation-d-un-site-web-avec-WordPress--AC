...
$GLOBALS['thinkup_theme_version'] = '1.5.9';
...
function thinkup_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 1', 'renden' ),
        'id'            => 'footer-w1',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 2', 'renden' ),
        'id'            => 'footer-w2',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 3', 'renden' ),
        'id'            => 'footer-w3',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 4', 'renden' ),
        'id'            => 'footer-w4',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 5', 'renden' ),
        'id'            => 'footer-w5',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 6', 'renden' ),
        'id'            => 'footer-w6',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Sub-Footer Column 1', 'renden' ),
        'id'            => 'sub-footer-w1',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
    ...
    register_sidebar( array(
        'name'          => __( 'Sub-Footer Column 2', 'renden' ),
        'id'            => 'sub-footer-w2',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="sub-footer-widget-title"><span>',
